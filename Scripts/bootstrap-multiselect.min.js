! function (t) {
    ...
    "undefined" != typeof ko && ko.bindingHandlers && !ko.bindingHandlers.multiselect && (ko.bindingHandlers.multiselect = {
        ...
        init: function (e, i, s, l, o) {
            ...
            var r = function (t) {
                setTimeout(function () {
                    n.multiselect(t ? "enable" : "disable")
                })
            };
            if (s.has("enable")) {
                var d = s.get("enable");
        ...
        buildDropdownOptions: function () {
            this.$select.children().each(t.proxy(function (e, i) {
                ...
                var i = t(e.target),
                    s = i.prop("checked") || !1,
                    l = t(e.target).closest("li"),
                    o = l.nextUntil("li.multiselect-group").not(".multiselect-filter-hidden").not(".disabled"),
                    n = o.find("input"),
                    a = [];
                this.options.selectedClass && (s ? l.addClass(this.options.selectedClass) : l.removeClass(this.options.selectedClass)), t.each(n, t.proxy(function (e, i) {
                    var l = t(i).val(),
                        o = this.getOptionByValue(l);
                ...
                var i = t(e.target).closest("li"),
                    s = i.nextUntil("li.multiselect-group").not(".multiselect-filter-hidden"),
                    l = !0;
                s.each(function () {
